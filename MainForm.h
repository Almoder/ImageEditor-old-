...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void) {
			...
			this->saveAsMI->Text = L"—Óı‡ÌËÚ¸ Í‡Í";
			...
			this->actionsMI->Text = L"ƒÂÈÒÚ‚Ëˇ";
			...
			this->powerButton->Text = L"œËÏÂÌËÚ¸";
			...
			this->binaryButton->Text = L"œËÏÂÌËÚ¸";
			...
			this->halftoneButton->Text = L"œËÏÂÌËÚ¸";
			...
			this->negativeButton->Text = L"œËÏÂÌËÚ¸";
			...
			this->label1_2->Text = L"œÓÎÛÚÓÌÓ‚ÓÂ";
